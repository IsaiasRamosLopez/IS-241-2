...
\course{ESTRUCUTURA DE DATOS (IS $-$ 241)}
\title{TAREA Nº 02 -Eficiencia de un Algoritmo (\emph{optimización})}
\tema{Encontrando Tiempos de Ejecución de un Algoritmo}
\teacher{Ing. Elinar Carrillo Riveros}
%-------------------------------------
